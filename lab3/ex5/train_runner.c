...
void enter_loading_bays(thread_task_t *task) {
  ...
  printf("[Train %3d] Start entry_controller_wait\n", task->train_id);
  entry_controller_wait(task->entry_controller);
  printf("[Train %3d] End entry_controller_wait\n", task->train_id);
...
void exit_loading_bays(thread_task_t *task) {
  ...
  printf("[Train %3d] Start exit_controller_wait\n", task->train_id);
  exit_controller_wait(task->exit_controller, task->priority);
  printf("[Train %3d] End exit_controller_wait\n", task->train_id);
  ...
  printf("[Train %3d] Start entry_controller_post\n", task->train_id);
  entry_controller_post(task->entry_controller);
  printf("[Train %3d] End entry_controller_post\n", task->train_id);
  ...
  printf("[Train %3d] Start exit_controller_post\n", task->train_id);
  exit_controller_post(task->exit_controller, task->priority);
  printf("[Train %3d] End exit_controller_post\n", task->train_id);
